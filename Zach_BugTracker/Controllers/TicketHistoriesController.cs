...
namespace Zach_BugTracker.Controllers
{
    ...
    public class TicketHistoriesController : Controller
    {
        ...
        {
            var ticketHistories = db.TicketHistories.Include(t => t.Ticket).Include(t => t.Updater);
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Property,OldValue,NewValue,UpdaterId,UpdatedDate")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Property,OldValue,NewValue,UpdaterId,UpdatedDate")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
